...
# This cell instantiates: shortpmos_2x, shortnmos_2x, nmos_8x2, flatpmos1x0_3

import pya

def build_ToBiasStartup(cell, L, cells):
    """Populate cell "ToBiasStartup" with shapes and sub-cell instances.
    Args:
        cell  – pya.Cell for "ToBiasStartup"
