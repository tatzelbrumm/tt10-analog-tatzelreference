...
# This cell instantiates: pmos_7x, nmos_5x

import pya

def build_OgueyAebischer_p7_n5(cell, L, cells):
    """Populate cell "OgueyAebischer_p7_n5" with shapes and sub-cell instances.
    Args:
        cell  – pya.Cell for "OgueyAebischer_p7_n5"
