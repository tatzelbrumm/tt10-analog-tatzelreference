...
# This cell instantiates: nmos1x20_8x

import pya

def build_nmos_1x80_2x(cell, L, cells):
    """Populate cell "nmos_1x80_2x" with shapes and sub-cell instances.
    Args:
        cell  – pya.Cell for "nmos_1x80_2x"
