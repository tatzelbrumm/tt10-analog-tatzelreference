...
# This cell instantiates: tatzelreference_tile

import pya

def build_tt_um_tatzelreference(cell, L, cells):
    """Populate cell "tt_um_tatzelreference" with shapes and sub-cell instances.
    Args:
        cell  – pya.Cell for "tt_um_tatzelreference"
    ...
    _txt.halign = 1
    _txt.valign = 1
    cell.shapes(L.L_71_5).insert(_txt)
    cell.shapes(L.L_71_16).insert(
        pya.DPolygon([pya.DPoint(128.19, 224.76), pya.DPoint(128.49, 224.76), pya.DPoint(128.49, 225.76), pya.DPoint(128.19, 225.76), pya.DPoint(128.19, 224.76)]))
    _txt = pya.Text("ena",
